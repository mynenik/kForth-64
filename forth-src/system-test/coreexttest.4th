...
:noname  ( c-addr u -- | Keep a cumulative error count )
  1 core-ext-errors +! error1 ;  error-xt !
...
\ -----------------------------------------------------------------------------
COMMENT Skipping tests of UNUSED
0 [IF]
...
\ -----------------------------------------------------------------------------
COMMENT Skipping tests of MARKER
0 [IF]
...
\ -----------------------------------------------------------------------------
COMMENT Skipping tests of BUFFER:
0 [IF]
TESTING BUFFER:
...
:NONAME 1234 ; NN1 !
:NONAME 9876 ; NN2 !
T{ NN1 a@ EXECUTE -> 1234 }T
T{ NN2 a@ EXECUTE -> 9876 }T
...
COMMENT Skipping tests of SAVE-INPUT and RESTORE-INPUT
0 [IF]
...
\ -----------------------------------------------------------------------------
COMMENT Skipping test of HOLDS
0 [IF]
