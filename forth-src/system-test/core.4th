...
COMMENT SKIPPING  GI5 tests "BEGIN...WHILE...WHILE...REPEAT...THEN" 
( *************************************************************
...
\ >NUMBER TESTS
CREATE GN-BUF 1 ?allot 0 swap c! \ 0 C,
: GN-STRING	GN-BUF 1 ;
...
CREATE SBUF 3 ALLOT SBUF DUP 12 SWAP C! 1+ DUP 34 SWAP C! 1+ 56 SWAP C!
